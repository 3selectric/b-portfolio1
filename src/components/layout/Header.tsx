      ...
      <div className="container-narrow px-6 md:px-8">
        <div className="flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg text-foreground">Electric Innovative Services</span>
          </a>
        ...
        {isMobileMenuOpen && (
          <nav className="md:hidden pt-6 pb-4 space-y-4">
            ...
            <Button variant="default" className="w-full mt-4" onClick={scrollToContact}>
              Contact
            </Button>
          </nav>
        )}
